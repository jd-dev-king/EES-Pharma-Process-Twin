    ...
    return (
      <div className="zone-stack">
        <div className="zone-heading">
          ...
          <StatusBadge label={`${bulkTanks.filter((tank) => tank.qa_status === "Released").length} released tanks`} tone="success" />
        </div>
    ...
    <div className="app-shell zoned-shell">
      <header className="topbar">
        <div className="brand-lockup">
          ...
          <div><p>Enterprise Execution Suite</p><small>Sprint 3.0.10.1 · Release Readiness UI Hotfix</small></div>
        </div>
